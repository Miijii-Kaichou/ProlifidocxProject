...
namespace Extensions
{
    ...
    public static class Constants
    {
        ...
        public const string STAGE_1 = "STAGE1_GRASSLANDS";
        public const string STAGE_2 = "STAGE2_SILKAS_FOREST";
        public const string STAGE_3 = "STAGE3_ANCIENT_CAPITOL";
        public const string STAGE_4 = "STAGE4_MOUNT_SAINTERE";
        public const string STAGE_5 = "STAGE5_WITHIN_THE_WITCHS_DOMAIN";
        public const string STAGE_6 = "STAGE6_INSIDE_THE_WITCHS_GRAVE";
        public const string STAGE_7 = "STAGE7_OUTSKITS_OF_MT_SAINTERE";
        public const string STAGE_8 = "STAGE8_STAR_SIMULATRE";
        public const string DIFFICULTY_SELECTION = "DIFFICULTY_SELECTION";
        public const string TUTORIAL_LOG = "TUTORIAL_LOG";
        public const string STAGE_SELECTION = "STAGE_SELECTION";
        public const string OPTIONS_MENU = "OPTIONS";
        public const string CHARACTER_SELECTION = "CHARACTER_SELECTION";
        public const string TITLE_SCREEN = "TITLE";
        public const string STAR_SIMULATRE_SELECTION = "STAR_SIMULATRE";
        public const string AKASHIC_RECORDS_ENTRY = "RECORDSANDHIGHSCORE";
        public const string AKASHIC_RECORDS_VIEW = "AKASHIC_RECORDS";
        public const string MUSIC_BOX = "MUSIC_BOX";
        public const string GALLERY = "GALLERY";
        public const string GRIMOIRELOG = "GRIMOIRE_LOG";
    ...
    public static class Convenience
    {
        ...
        public static void Load(this UnityEngine.Object scene)
        {
            if (scene.GetType() == typeof(Scene))
                GameSceneManager.LoadScene(scene.name);
        }
        ...
        public static int Next(this int _)
        {
            _++;
            return _;
        }
